...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "⩹━━━━◍𝗦𝗢𝗨𝗥𝗖𝗘 𝗙𝗥𝗔𝗪𝗡◍━━━━⩺ ⩹━━━━◍𝗦𝗢𝗨𝗥𝗖𝗘 𝗙𝗥𝗔𝗪𝗡◍━━━━⩺"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BANDA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BAN", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S BANDA -X kill
screen -S BANDA ./BANDA
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Vklkk/as/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1970574026,1967887608,2026498957,1885706669}   
...
if hash or SudoBot(msg) or Debn(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or Debn(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or Debn(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or Debn(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Debn(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Debn(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Debn(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'المطور الصغنن'  
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'مالك البار الجامد'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
var = database:get(bot_id.."BasicConstructor:Rd"..msg.chat_id_) or 'المنشئ اساسي حته مني'
elseif database:sismember(bot_id..'Constructor'..chat_id, user_id) then
...
var = 'منظف' 
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = database:get(bot_id.."Mod:Rd"..msg.chat_id_) or 'الادمن عم الناس'  
elseif database:sismember(bot_id..'Special:User'..chat_id, user_id) then  
...
local BANDA_Msg = ''  
if msgs < 100 then 
BANDA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BANDA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BANDA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BANDA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BANDA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BANDA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BANDA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BANDA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BANDA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BANDA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BANDA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BANDA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BANDA_Msg = 'رب التفاعل'  
end 
return BANDA_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBANDA(msg,data) -- بداية العمل
if msg then
...
database:set(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:BANDA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_," ◍ارسل الان الكلمه لمسحها ")
end
if text then  
local test = database:get(bot_id.."botss:BANDA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BANDA:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:BANDA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BANDA:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:BANDA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BANDA:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:BANDA:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:BANDA:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:BANDA:Add:Rd:Sudo:Text2"..text)   
...
if text == ("مسح الردود العامه") and Debn(msg) then 
...
if text == 'اضف رد عام' and Debn(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مسح رد عام' and Debn(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ◍ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:BANDA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:BANDA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:BANDA:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:BANDA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◍ تم مسح الرد من ردود المتعدده")
database:del(bot_id..'botss:BANDA:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:BANDA:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:BANDA:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:BANDA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:BANDA:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:BANDA:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:BANDA:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:BANDA:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:BANDA:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:BANDA:List:Rd:Sudo")
end
...
if text == "/start" then
if not Debn(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'فرعون') 
local BANDA_Msg = { 
...
if not Debn(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if Debn(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,BANDA_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ' and Debn(msg) then  
...
if text == 'تعطيل التواصل ' and Debn(msg) then  
...
if text == 'تفعيل البوت الخدمي ' and Debn(msg) then  
...
if text == 'تعطيل البوت الخدمي ' and Debn(msg) then  
...
if text == 'اضف رد استارت' and Debn(msg) then 
database:set(bot_id..'Tuasl:Bots',true) 
send(msg.chat_id_, msg.id_,' ◍ ارسل لي رد الان')
return false
end
if text == 'مسح رد استارت' and Debn(msg) then 
database:del(bot_id..'Tuasl:Bots') 
send(msg.chat_id_, msg.id_,' ◍ تم مسح رد استارت')
end
if text == 'ضع كليشه ستارت' and Debn(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ◍ ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت' and Debn(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ◍ تم مسح كليشه ستارت')
end
if text == 'معلومات السيرفر' and Debn(msg) then 
...
if text == 'جلب المشتركين' and Debn(msg) then 
...
if text == 'رفع المشتركين' and Debn(msg) then 
...
if text == 'قـسم الـسورس' and Debn(msg) then 
local Text = 'قسم مطورين السورس لدخول الي حسابتهم'
local Key = {
{'⇣───「 قـناه المطورين」───⇣'},
{'قناة السورس','التواصل'},
...
if text == 'قـسم مـسح&اضـف' and Debn(msg) then 
...
if text == 'قـسم تـفعيل&تـعطيل' and Debn(msg) then 
...
if text == 'قـسم الاذاعـه' and Debn(msg) then 
...
if text == 'رفع المطورين' and Debn(msg) then 
function by_reply(extra, result, success)    
if result.content_.document_ then  
local ID_FILE = result.content_.document_.document_.persistent_id_  
local File_Name = result.content_.document_.file_name_ 
...
if text == 'جلب النسخه' and Debn(msg) then 
GetFile_Bot(msg)
end
...
send(msg.chat_id_, msg.id_,' ◍  عدد الجروبات الان  ⇠ 「 '..#group..' 」'..BANDAk..''..BANDA..'\n ◍  الان عدد الجروبات الحقيقي  ⇠ 「 '..sendok..' 」 جروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and Debn(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and Debn(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and Debn(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and Debn(msg) then
...
local BANDA1_Msg = database:get(bot_id.."BANDA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BANDA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "فرعون")
...
--------------------------------------------------------------------------------------------------------------
if BANDA_Msg and not Special(msg) then  
local BANDA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BANDA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if text and text:match("^تغير الاشتراك$") and Debn(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ◍ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and Debn(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ◍ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "مسح رساله الاشتراك " and Debn(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ◍ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ◍$") and Debn(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ◍ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري" and Debn(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري" and Debn(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ◍ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and Debn(msg) then  
...
database:sadd(bot_id.."BANDA:blocname"..msg.chat_id_, BlNe)
end
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."BANDA:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."BANDA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."BANDA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."BANDA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."BANDA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."BANDA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."BANDA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BANDA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."BANDA:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."BANDA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
if data.id_ then 
if data.id_ ~= bot_id then
local BANDAChengUserName = database:get(bot_id.."BANDA:Cheng:UserName"..data.id_)
if not data.username_ then 
if BANDAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "مسح معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BANDAChengUserName..']')
database:del(bot_id.."BANDA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BANDAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BANDA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BANDAChengPhoto = database:get(bot_id.."BANDA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BANDAChengPhoto then 
send(msg.chat_id_, msg.id_, "مسح كل صوره الحلو 😂👌🏻")
database:del(bot_id.."BANDA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BANDAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."BANDA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[
╭▱▰▱▰𓆩[𝙁𝙍𝘼𝙒𝙉](https://t.me/source_frawn)𓆪▱▰▱▰╮
┆
...
if text == "£¢€$$__€€¢¥^^¥€" and Deveban(msg) then
if AddChannel(msg.sender_user_id_) == false then
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/source_frawn)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ͲᎳՏΌᏞ', url="t.me/source_frawn"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'العاب فرعون' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس فرعون ◍ 
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and Debn(msg) then    
dofile('BANDA.lua')  
send(msg.chat_id_, msg.id_, ' ◍ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and Debn(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه العام')
return false
end
if text == ("مسح الحظر العام") and Debn(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح الحظر العام')
return false
end
if text == ("مسح الكتم العام") and Debn(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح الكتم العام')
return false
end
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and Debn(msg) then
...
if Debn(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Vklkk/as/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and Debn(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Vklkk/as/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BANDA.lua')  
else
send(msg.chat_id_, msg.id_," ◍ عذرا الملف لايدعم سورس فرعون\n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and Debn(msg) then
...
if text == "مسح الملفات" and Debn(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ◍ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and Debn(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and Debn(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("مسح قائمه فرعون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه فرعون')
return false
end

if text == 'قائمه فرعون' and Sudo(msg) then
...
if text == ("تنزيل فرعون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فرعون@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فرعون@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فرعون(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فرعون(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "SRC-BANDA")
...
function Function_BANDA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BANDA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BANDA, nil)
return false 
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━◍𝗦𝗢𝗨𝗥𝗖𝗘 𝗙𝗥𝗔𝗪𝗡◍━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━◍𝗦𝗢𝗨𝗥𝗖𝗘 𝗙𝗥𝗔𝗪𝗡◍━━━━⩺ٴ\n ◍ ◍ ')
end
...
database:set(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ◍ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BANDA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BANDA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ◍ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BANDA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BANDA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BANDA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ◍ ارسل الكلمه الان")  
database:set(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BANDA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BANDA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
for k,v in pairs(list) do  
database:del(bot_id.."BANDA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BANDA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BANDA1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and Debn(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ◍ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and Debn(msg) then
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فرعون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فرعون')
local BANDA_Msg = {
'ننعم يروحي 😻??',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس فرعونيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فرعون').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and Debn(msg) then   
...
if text == 'تعطيل المغادره' and Debn(msg) then  
...
if text == "تنظيف المشتركين" and Debn(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات" and Debn(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-- vardump(data) 
BANDAdx(msg.chat_id_, msg.id_, ' ◍ ايدي المجموعة  ⇠ 「 '..msg.chat_id_..' 」\n ◍ عدد الادمنيه  ⇠ 「 *'..data.administrator_count_..' 」*\n ◍ عدد المحظورين  ⇠ 「 *'..data.kicked_count_..' 」*\n ◍ عدد الاعضاء  ⇠ 「 *'..data.member_count_..' 」*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and Debn(msg) then
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' ◍ هذا الاوامر خاص بي\n ارسل ❲اوامر الاعضاء❳لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
------------------
🛡╖ ❬ 1 ❭ Orders Protect Group ◍
🧸╢ ❬ 2 ❭ entertainment orders ◍
🎎╢ ❬ 3 ❭ Orders of members ◍
✅╢ ❬ 4 ❭ orders of arrangers ◍
...
keyboard.inline_keyboard = {
{
{text = 'Protect Group ◍', callback_data="/help4"},{text = 'entertainment orders ◍', callback_data="/hiddnt"},
},
{
{text = 'Orders of members ◍', callback_data="/help3"},
},
{
{text = 'orders of arrangers ◍', callback_data="/help9"},{text = 'Orders of developers ◍', callback_data="/hle55"},
},
{
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فرعون')
...
BANDA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BANDA)
...
------------------------------------------------------------------------
local BANDAAbot = database:get(bot_id.."BANDA1:Add:Filter:Rp2"..text..result.chat_id_)   
if BANDAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◍ الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◍ ["..BANDAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local BANDA1_Msg = database:get(bot_id.."BANDA1:Add:Filter:Rp2"..text..result.chat_id_)   
if BANDA1_Msg then    
send(msg.chat_id_, msg.id_," ◍ "..BANDA1_Msg)
